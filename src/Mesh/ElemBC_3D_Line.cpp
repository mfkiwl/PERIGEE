...
ElemBC_3D_Line::ElemBC_3D_Line( const std::vector<std::string> &vtpfileList )
{
  ...
  std::cout<<"===> ElemBC_3D_Line specified by \n";

  for(int ii=0; ii<num_ebc; ++ii)
  {
    std::cout<<"     ebc_id = "<<ii<<": "<<vtpfileList[ii]<<'\n';

    cell_nLocBas[ii] = 1; // boundary of line is a single node
    TET_T::read_purkinje_nodes( vtpfileList[ii], num_node[ii], num_cell[ii], 
...
void ElemBC_3D_Line::print_info() const
{
  std::cout<<"========================= \n";
  std::cout<<"ElemBC_3D_Line : ";
