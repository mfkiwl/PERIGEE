  ...
  elemType(in_elemType)
{
  ...
  // Check the cpu info
  SYS_T::print_exit_if(cpu_size < 1, "Error: Part_Line input cpu_size is wrong! \n");
  SYS_T::print_exit_if(cpu_rank >= cpu_size, "Error: Part_Line input cpu_rank is wrong! \n");
  SYS_T::print_exit_if(cpu_rank < 0, "Error: Part_Line input cpu_rank is wrong! \n");
...
void Part_Line::Generate_Partition( const IMesh * const &mesh,
    const IGlobal_Part * const &gpart,
    const Map_Node_Index * const &mnindex,
    const IIEN * const &IEN,
    const std::vector<double> &ctrlPts,
...
int Part_Line::get_elemLocIndex(const int &gloindex) const
{
...
void Part_Line::write( const char * inputFileName ) const
{
...
void Part_Line::print_part_ele() const
{
...
void Part_Line::print_part_node() const
{
...
void Part_Line::print_part_ghost_node() const
{
...
void Part_Line::print_part_local_to_global() const
{
...
void Part_Line::print_part_LIEN() const
{
...
void Part_Line::print_part_loadbalance_edgecut() const
{
  std::cout<<"Proc:"<<" "<<cpu_rank;
