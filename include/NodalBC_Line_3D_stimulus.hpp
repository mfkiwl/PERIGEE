#ifndef NODALBC_LINE_3D_STIMULUS_HPP
#define NODALBC_LINE_3D_STIMULUS_HPP
// ==================================================================
// NodalBC_Line_3d_stimulus.hpp
// modified from NodalBC_3D_inflow.hpp
// 
// This is an instantiation of INodalBC for application of
// stimulus current at the nodes of line elements 
//
...
class NodalBC_Line_3D_stimulus : public INodalBC
{
  public:
    // --------------------------------------------------------------
    // Generate an empty inflow type boundary condition class
    // --------------------------------------------------------------
    NodalBC_Line_3D_stimulus(const int &nFunc);
...
//        const int &elemtype = 501 );
    ...
    virtual ~NodalBC_Line_3D_stimulus() {};
