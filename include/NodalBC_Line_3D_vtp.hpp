#ifndef NODALBC_LINE_3D_VTP_HPP
#define NODALBC_LINE_3D_VTP_HPP
// ==================================================================
// NodalBC_Line_3D_vtp.hpp ,
// Modified from the original : NodalBC_3D_vtp.hpp
//
// This is an instantiation of INodalbc for 3D problems by reading the
// dirichlet nodes from the vtp file.
//
// This class is designed to handle the mesh for unstructural Line
...
class NodalBC_Line_3D_vtp : public INodalBC
{
  public:
    // --------------------------------------------------------------
    ...
    // --------------------------------------------------------------
    NodalBC_Line_3D_vtp( const int &nFunc );
    
//    // --------------------------------------------------------------
//    // The vtp file specifies the Dirichlet nodes. No periodical BC.
//    // --------------------------------------------------------------
//    NodalBC_Line_3D_vtp( const std::string &vtpfileName, const int &nFunc );
//
//    // --------------------------------------------------------------
//    // The list of vtp files specifies the Dirichlet nodes. 
//    // No periodical type BC nodes.
//    // --------------------------------------------------------------
//    NodalBC_Line_3D_vtp( const std::vector<std::string> &vtpfileList, 
//        const int &nFunc );
//
//    // --------------------------------------------------------------
...
//    // identical to the NodalBC_Line_3D_vtp(vtpfilelist, nFunc, master_idx),
