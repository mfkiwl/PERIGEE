#ifndef PART_LINE_HPP
#define PART_LINE_HPP
// ==================================================================
// Part_Line.hpp
//
...
//         the implicit solver.
// Modified 2021: derived partition function for line elements
// ==================================================================
#include "IMesh.hpp"
#include "IPart.hpp"

class Part_Line : public IPart
{
  public:
    Part_Line( const IMesh * const &mesh,
