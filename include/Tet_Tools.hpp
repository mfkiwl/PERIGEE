...
namespace TET_T
{
  ...
  // ================================================================
  //  read vtu file with fiber direction information. fiber orientations
  //  should be given per element, with a name containing "fib", case
  //  insensitive. 
  // ----------------------------------------------------------------
  void read_vtu_grid( const std::string &filename,
		      int &numpts, int &numcels,
  ...
  // ================================================================
  //  read vtu file with fiber direction information as above and in addition
  //  read a displacement field. I use this to simulate electrophysiology on
  //  grown myocardium mesh, for example. 
  // ----------------------------------------------------------------
  void read_vtu_grid( const std::string &filename,
		      int &numpts, int &numcels,
		      std::vector<double> &pt, std::vector<int> &ien_array,
