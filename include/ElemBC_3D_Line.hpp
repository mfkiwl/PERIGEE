#ifndef ELEMBC_3D_LINE_HPP
#define ELEMBC_3D_LINE_HPP
// ==================================================================
// ElemBC_3D_Line.hpp
//
// This is an instantiation of ElemBC for 3D problems described by 
// line elements. For line elements, the boundary is
// described by nodes. This information 
// can be obtained directly from the mesher and one
...
// boundaries This number  is also recorded as num_ebc;
// (those boundaries require integration in case of
// triangles but not in Line elements, this may be redundant when we have
// nodal BC implementation). 
//
...
class ElemBC_3D_Line : public ElemBC
{
  public:
    ElemBC_3D_Line( const std::vector<std::string> &vtpfileList );

    virtual ~ElemBC_3D_Line();
