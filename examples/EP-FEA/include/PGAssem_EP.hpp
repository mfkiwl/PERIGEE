...
private:
  ...
  // ------------------------------------------------------------------------
  void EssBC_KG( const ALocal_NodalBC * const &bc_part, const int &field );

  // ------------------------------------------------------------------------
  // ! Enforce essential bc for the residual vector
  // ------------------------------------------------------------------------
  void EssBC_G( const ALocal_NodalBC * const &bc_part, const int &field );
  ...
  //   array_xx & vector_xx are used to store this partition's nodes'
  //   solution vector
  double * array_a;
  double * array_b;
