    ...
    ) const
{
  ...
  while( time_info->get_time() < final_time ){
    ...
    //pre_hist->PrintNoGhost();
    //std::cout << "sol at the beginning: " << std::endl;
    //pre_disp->PrintNoGhost();
    //
    ...
    //				  cur_disp, cur_hist);
    //
    //std::cout << "cur hist: " << std::endl;
    //cur_hist->PrintNoGhost();
    //std::cout << "cur disp: " << std::endl;
