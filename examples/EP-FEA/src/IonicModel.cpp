  ...
  for(int i=0; i<time_steps; ++i)
    {
      ...
      K2V   = (V_new_tmp - (V_old+0.5*K1V));                
      K2r   = VEC_T::VminusV(r_new_tmp, VEC_T::VplusV(r_old, VEC_T::Vxa(K1r,0.5))) ;
      
      //3rd pass
      run_ionic(VEC_T::VplusV(r_old, VEC_T::Vxa(K2r,0.5)) , V_old + 0.5*K2V,
      		I_stim.at(1), dt, r_new_tmp, V_new_tmp);
      K3V   = (V_new_tmp - (V_old+0.5*K2V));                
      K3r   = VEC_T::VminusV(r_new_tmp, VEC_T::VplusV(r_old, VEC_T::Vxa(K2r,0.5))) ;
      
      //4th pass
      run_ionic(VEC_T::VplusV(r_old ,K3r) , V_old + K3V,
      		I_stim.at(2), dt, r_new_tmp, V_new_tmp); 
      K4V   = (V_new_tmp - (V_old+K3V));                
      K4r   = VEC_T::VminusV(r_new_tmp, VEC_T::VplusV(r_old ,K3r)) ;
