...
//void PTime_Solver_NLHeat_GenAlpha::TM_NewtonRaphson(
//    const PDNSolution * const &init_disp,
//    PDNTimeStep * const &time_info,
//    const ALocal_Elem * const &alelem_ptr,
//    const ALocal_IEN * const &lien_ptr,
...
//
//
//void PTime_Solver_NLHeat_GenAlpha::TM_VMS_generalized_alpha(
//    const PDNSolution * const &init_velo,
//    const PDNSolution * const &init_disp,
//    PDNTimeStep * const &time_info,
//    const TimeMethod_GenAlpha * const &tmga_ptr,
...
//
//
//void PTime_Solver_NLHeat_GenAlpha::TM_VMS_generalized_alpha_noCache_3D(
...
//    IPGAssem * const &gassem_ptr,
//    PLinear_Solver_PETSc * const &lsolver_ptr,
//    PNonlinear_Solver_NLHeat_GenAlpha * const &nsolver_ptr ) const
//{
//  // allocate solution vector in memory
//  PDNSolution * curr_disp = new PDNSolution(*init_disp);
//  PDNSolution * next_disp = new PDNSolution(*init_disp);
...
//
//
//void PTime_Solver_NLHeat_GenAlpha::TM_GenAlpha(
//    const bool &restart_init_assembly_flag,
